...
;-------this checks and changes am/pm for the alarm
checkMeridiemAlarm:
	mov a, hrsAlarm
    cjne A, #12H, not12Alarm ;if it isn't 12, leave
    
    jb still12Alarm, out ;if it is 12 but was previously 12, do nothing
changeMeridiemAlarm: ;if it is 12 but was not previously 12 - now change meridiem
   	mov a, meridiemAlarm
   	cpl acc.2 ; changes 08H to 0CH and vice versa
  	mov meridiemAlarm, a	
	;display am/pm
